...
%set Dataset Path
salDir = 'F:/MTexperiments/VideoSOD1129/VideoSOD/experiments/swin_xr1_mod_2.5e-05/save_images/';  % 这里放模型的prediction
gtDir = 'gts';   % 这里给eval文件夹下gt文件夹的路径
Results_Save_Path = 'result/xr1_mod/';  % 这里给eval文件夹下result文件夹的路径

Models = {'30_epoch'}; 
Datasets = {'DAVSOD-Difficult-20'}; % 'DAVSOD-Difficult-20', 'FBMS', 'SegTrack-V2', 'ViSal','YouTube-Objects', 'DAVSOD', 'DAVSOD-Normal-25' ,'MCL', 'UVSD', 'VOS'
